...
GitHub_pic= current_dir / "assets" / "Git.png"
LinkedIn_pic= current_dir / "assets" / "Link.png"
...
with cols[0]:
    pic = Image.open(LinkedIn_pic)
    st.image(pic, width=50)
    st.write("[Linkedin](https://linkedin.com/in/radenbimo/)",align_text='center')
with cols[1]:
    pic = Image.open(GitHub_pic)
    st.image(pic, width=50)
    st.write("[GitHub](https://github.com/RadenBimo)",align_text='center')
with cols[2]:
